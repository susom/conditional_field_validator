...
class ConditionalFieldValidator extends \ExternalModules\AbstractExternalModule {
    ...
    public function redcap_survey_page_top( int $project_id, string $record, string $instrument, int $event_id, int $group_id, string $survey_hash, $response_id, $repeat_instance ) {
